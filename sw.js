// SW v7 - network-first + version bump
const CACHE='finapp-pwa-v8';
const ASSETS=['./','./index.html','./app.js?v=4.1','./manifest.webmanifest','./icon-192.png','./icon-512.png','./favicon.ico'];
